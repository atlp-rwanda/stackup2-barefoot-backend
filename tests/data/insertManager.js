...
const insertManager = async () => {
    ...
    VALUES('Louise','Patrick','patrick','patrick@gmail.com','$2b$10$fRo9jYWBNmom2iZ3H2./Iu9bOHHPKn3zJMNYjUKRvg7.9ysIEwJ5S','barefootNomad','Male','Kigali','manager','true','true', 'true',NOW(),NOW())`;

...
const {
  ...
  requestsRetrieved, noRequestsFound, noRequestsFoundOnThisPage, pageMustBeANumber,
...
describe('Testing other cases on comments', () => {
  it('Posting comment with valid data, expect to return an object with 201 status code and message and data as properties', (done) => {
    chai
      .request(server)
  ...
  it('Posting comment on notFoundRequest, expect to return an object with 404 status code and message and data as properties', (done) => {
    chai
      .request(server)
  ...
  it('Reading comment on my request from not exists page, expect it to return an object with error with 404 status code', (done) => {
    chai
      .request(server)
  ...
  it('Reading comment on my request with requester token with no comment yet, expect it to return an object with message and data properties with 200 status code', (done) => {
    chai
      .request(server)
  ...
  it('Updating comment which is not mine, expect it to return a response of 401 status code and an object containing error message', (done) => {
    chai
      .request(server)
  ...
  it('Updating comment which is mine, expect it to return a response of 200 status code and an object containing message and data as properties', (done) => {
    chai
      .request(server)
      .patch('/api/trips/comment/1')
      .set('Authorization', authToken)
  ...
  it('Updating comment which doesn\'t exist, expect it to return a response of 404 status code and an object containing error message', (done) => {
    chai
      .request(server)
  ...
  it('Posting comment on other user\'s request while I am not a manager, expect it to return a response of 401 status code and an object containing error message', (done) => {
    chai
      .request(server)
  ...
  it('Posting comment with weird data, expect it to return a response of 401 status code and an object containing error message', (done) => {
    chai
      .request(server)
  ...
  it('Posting comment as a manager on any request, expect it to return response with 201 status code and an object with message and data properties', (done) => {
    chai
      .request(server)
      .post(`/api/trips/${requestId2}/comment`)
      .set('Authorization', authTokenManager)
  ...
  it('Login user who doesn\'t have any request', (done) => {
    chai
      .request(server)
      .post('/api/auth/login')
      .set('Accept', 'Application/json')
...
describe('Trips stats', () => {
  it('Login a manager should return 200', (done) => {
    chai
      .request(server)
      .post('/api/auth/login')
      .set('Accept', 'Application/json')
